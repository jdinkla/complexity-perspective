...
- `just clean` - Clean build artifacts (removes `build/` and other generated files)
...
- `web/` - Web application code and HTML files
  ...
  - HTML files reference compiled JavaScript using `../build/` paths
- `lib/` - Dart library code (core data structures, models, simulations)
