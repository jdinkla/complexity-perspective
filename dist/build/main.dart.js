...
(function dartProgram() {
  ...
  var A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      ...
      if (t1 != null)
        J.set$text$x(t1, "Your Dart app is running.");
    }
  },
  J = {
